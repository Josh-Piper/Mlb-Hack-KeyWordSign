      ...
      <div className='container'>
        ...
        <div className='about'>
          ...
          <div className='about_block'>
            ...
            <div className='about_block_text'>
              This application is an Augmentative and Alternative Communication program to help children and adults communicate with each other. Many adults may not know Key Word Sign nor AusLan, in which case they can open the application for clarification.
            </div>
          </div>
